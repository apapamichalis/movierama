...
=begin 
    sum supposed to be faster than count.
    ...
    assignment like this. Even so it would be wise to update the whole columns each time a user or movie
    got deleted. It would also help a lot when sorting movies by likes/hates. If I had the time I would 
    be building both solutions for comparison.
=end
