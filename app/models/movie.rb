...
=begin 
    ...
    Since destroy is called rarely (in comparison with create or view(index/show - even update)
    this could lead to benefits performance-wise, but is not the safe path to follow for an
    assignment like this. It would also help a lot when sorting movies by likes/hates. If I had
    the time I would be building both solutions for comparison.
=end
